    ...
    <section class="header_bottom">
        ...
        <div class="header_bottom_right">
            ...
            <div>
                ...
                <a id="logButton" class="button is-success is-light is-small" href="/login">로그인</a>
            </div>
        </div>
    </section>
</div>`,
...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    if (response.ok) {
      ...
      logButton.className = "button is-danger is-light is-small";
    } else {
...
const loadCategory = async () => {
  ...
  higher_category.forEach(async (higerItem) => {
    const lower_category = await getLowerCategory("키보드");
    categoryDiv.insertAdjacentHTML(
      "beforeend",
      generateCategoryHtml(higerItem, lower_category),
    );
  });
};
