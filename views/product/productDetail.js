...
btnCart.addEventListener('click', function () { 
  ...
  const sameProduct = cartItem.find(cartProduct => cartProduct.product_number === productObj.product_number)
...
function modalClose() {
  ...
  // 이벤트 누적 방지
  popBtnConfirm.removeEventListener('click', modalMsg[buyFlag].btnConfirm.function)
  popBtnCancel.removeEventListener('click', modalMsg[buyFlag].btnCancel.function)
}
